...
class CarJPARepositoryTest @Autowired constructor(
    ...
    fun testAddCar() {
        ...
        val vin = "VIN1"
        val car = Car(UUID.fromString("3b572be6-02e1-4b73-93b8-cb7a3648bc83"), date = LocalDate.now(), manufacturer = manufacturer, model = model,productionYear = productionYear, vin = vin, checkUps = mutableListOf<CarCheckUp>())
    ...
    fun testGetAllCars() {
        ...
        val vin1 = "VIN1"
        val car1 = Car(car1Id, LocalDate.now(), manufacturer1, model1, productionYear1, vin1 )
        ...
        val vin2 = "VIN2"
        val car2 = Car(car2Id, LocalDate.now(), manufacturer2, model2, productionYear2, vin2 )
        ...
        Assertions.assertEquals(manufacturer1, car1FromDb?.manufacturer)
        Assertions.assertEquals(model1, car1FromDb?.model)
        ...
        Assertions.assertEquals(manufacturer2, car2FromDb?.manufacturer)
        Assertions.assertEquals(model2, car2FromDb?.model)
